		...
		switch (rtype){
			case 'C':
				...
				if(!calib.init){
					...
					"date,time,decimal time (secs.ms),mV,Excite,offset,temp,humitiy, calib updated?,calib time(s.ms),calib mV, calib excite, calib offset,strains uncorrected,corrected\n");
					calib.init=true;
				...
				printf("\nesim: %f e: %f calib: %f\n\n",esim,e,calib.escale);
				printf("%8s %10s %8s %8s %8s %8s %10s %8s %14s %14s\n",
					"sample",
					"sample",
					"sample",
					"sample",
