...
export const FlowchartContent: FC<{ src: string }> = ({ src }) => (
  <>
    ...
    <div className="relative" style={{ background: 'green' }}>
      ...
      <Box top="19" left="13" width="26" height="13" leftDropdown="50">
        <h1>Mold Prep</h1>
        <p>Description</p>
        <p>-</p>
      ...
      <Box top="19" left="74.5" width="12" height="13" leftDropdown="-150">
        <h1>Bulk Complete</h1>
        <p>-</p>
        <p>Description</p>
      ...
      <Box top="79" left="41" width="10" height="13" topDropdown="-500">
