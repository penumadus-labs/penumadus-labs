...
getTankInit(const char *filename){
	...
	if(defaultflag){
		Serial.println(F("Some Values Have assumed Default Values"));
	}
	...
	Serial.print(F("tankInit.accelsampint:"));
	Serial.println(tankInit.accelsampint);
