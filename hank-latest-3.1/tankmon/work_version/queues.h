...
//PONDSCUM TEST
//#define BACKSAMPLES 10	//how many samples to keep in arrears for accel
//#define FWDSAMPLES 10	//how many samples to send after an event
